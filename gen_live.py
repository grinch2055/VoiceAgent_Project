...
# MLP: nn.Sequential (keys: 0,2,4 for Linear layers) - EXACT MATCH
def create_mlp():
...
print("? Ready. Speak clearly. Ctrl+C to stop.\\n")
...
with open("live_control_real.py", "w", encoding="utf-8") as f:
    f.write(code)
print("? live_control_real.py created.")
